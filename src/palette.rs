...
pub static PAL_GRAY_8BIT: [u8; 768] = [
...
pub static PAL_XTERM256: [u8; 768] = [
...
pub static PAL_VT340_MONO: [u8; 48] = [
    (13u32 * 255 / 100) as u8,
    (13u32 * 255 / 100) as u8,
    (13u32 * 255 / 100) as u8,
    (26u32 * 255 / 100) as u8,
...
pub static PAL_VT340_COLOR: [u8; 48] = [
    (20u32 * 255 / 100) as u8,
    (20u32 * 255 / 100) as u8,
    (80u32 * 255 / 100) as u8,
    (80u32 * 255 / 100) as u8,
